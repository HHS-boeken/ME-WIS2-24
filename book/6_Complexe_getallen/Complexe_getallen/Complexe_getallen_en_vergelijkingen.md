...
## 7.7.2 Het oplossen van $z^n = c$, waarbij $n \in \mathbb{N}$, $n>2$ en  $c \in \mathbb{C}$ 
...
## 7.7.4 Het oplossen van $z^n = c$, waarbij $n \in \mathbb{N}$, $n>2$ en  $c \in \mathbb{C}$ (Vervolg)
