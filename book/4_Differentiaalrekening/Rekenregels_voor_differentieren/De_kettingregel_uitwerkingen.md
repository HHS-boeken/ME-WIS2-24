...
$$
    \dfrac{df}{dx} = 3 \cdot 5^{3x-2} \ln(5)
$$
...
$$
    \dfrac{df}{dx} = 2x \cdot 3^{x^2} \ln(3)
$$
...
$$
    \dfrac{df}{dx} = \dfrac{12x^2+2}{(4x^3+2x) \ln(10)}
$$
